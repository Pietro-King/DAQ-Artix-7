...
HD_PWD='C:/Users/Tesista/Desktop/vivado projects/fix_7_novembre/fix_7_novembre.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log ADC_BRIDGE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_BRIDGE.tcl -notrace
