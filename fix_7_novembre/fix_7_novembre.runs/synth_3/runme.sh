...
HD_PWD='C:/Users/Tesista/Desktop/vivado projects/fix_7_novembre/fix_7_novembre.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log ADC_BRIDGE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_BRIDGE.tcl
