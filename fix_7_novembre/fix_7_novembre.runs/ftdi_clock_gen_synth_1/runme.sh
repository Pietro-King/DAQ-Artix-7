...
HD_PWD='C:/Users/Tesista/Documents/Git Repository Tesi Fiorini/king_adc/king_adc.runs/ftdi_clock_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ftdi_clock_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ftdi_clock_gen.tcl
