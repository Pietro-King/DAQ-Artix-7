...
HD_PWD='C:/Users/Tesista/Documents/Git Repository Tesi Fiorini/king_adc/king_adc.runs/receiver_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log receiver_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source receiver_FIFO.tcl
