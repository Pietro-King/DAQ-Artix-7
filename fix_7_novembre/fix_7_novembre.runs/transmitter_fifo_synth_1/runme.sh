...
HD_PWD='C:/Users/Tesista/Desktop/vivado projects/fix_7_novembre/fix_7_novembre.runs/transmitter_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transmitter_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transmitter_fifo.tcl
