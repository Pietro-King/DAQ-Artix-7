...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_read_button_IBUF]
...
set_property PACKAGE_PIN E5 [get_ports  i_read_button ]
set_property PACKAGE_PIN D4 [get_ports  o_trigger ]
#---------------------------------------------------
