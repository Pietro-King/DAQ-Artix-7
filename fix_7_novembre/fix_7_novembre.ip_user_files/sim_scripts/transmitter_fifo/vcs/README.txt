...
#
# Generated by export_simulation on Thu Nov 09 15:26:59 +0100 2017
#
################################################################################
...
switch to the './transmitter_fifo.sh' script.

./transmitter_fifo.sh -reset_run
...
./transmitter_fifo.sh -noclean_files

For more information on the script, please type './transmitter_fifo.sh -help'.
