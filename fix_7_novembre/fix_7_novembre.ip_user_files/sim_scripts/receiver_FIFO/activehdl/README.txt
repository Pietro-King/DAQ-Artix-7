...
#
# Generated by export_simulation on Mon May 22 16:11:56 +0200 2017
#
################################################################################
...
switch to the './receiver_FIFO.sh' script.

./receiver_FIFO.sh -reset_run
...
./receiver_FIFO.sh -noclean_files

For more information on the script, please type './receiver_FIFO.sh -help'.
