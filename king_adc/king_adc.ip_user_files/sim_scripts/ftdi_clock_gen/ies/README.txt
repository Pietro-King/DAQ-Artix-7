...
#
# Generated by export_simulation on Mon May 22 16:09:31 +0200 2017
#
################################################################################
...
switch to the './ftdi_clock_gen.sh' script.

./ftdi_clock_gen.sh -reset_run
...
./ftdi_clock_gen.sh -noclean_files

For more information on the script, please type './ftdi_clock_gen.sh -help'.
